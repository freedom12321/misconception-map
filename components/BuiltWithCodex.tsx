  ...
  return (
    <section className="codex-section" id="built-with-codex" aria-labelledby="codex-title">
      ...
      <div className="codex-grid">
        <div className="codex-story"><span className="codex-mark">⌘</span><div><span className="micro-label">CODEX · BUILD TIME</span><h3>From instructional idea to tested product</h3><p>Codex scaffolded the App Router architecture, translated the coaching workflow into a shared Zod schema, implemented the protected API route and sample-only fallback, designed the evidence-first interface, built useful exports, and wrote the tests and judging materials.</p></div></div>
